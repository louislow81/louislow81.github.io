...
!function(e,t){"use strict";"object"==typeof exports?module.exports=t(require("jquery")):"function"==typeof define&&define.amd?define(["jquery"],t):t(e.jQuery)}(this,function(e){var t=function(e,t){var n,a=document.createElement("canvas");e.appendChild(a),"undefined"!=typeof G_vmlCanvasManager&&G_vmlCanvasManager.initElement(a);var i=a.getContext("2d");a.width=a.height=t.size;var r=1;window.devicePixelRatio>1&&(r=window.devicePixelRatio,a.style.width=a.style.height=[t.size,"px"].join(""),a.width=a.height=t.size*r,i.scale(r,r)),i.translate(t.size/2,t.size/2),i.rotate((t.rotate/180-.5)*Math.PI);var o=(t.size-t.lineWidth)/2;t.scaleColor&&t.scaleLength&&(o-=t.scaleLength+2),Date.now=Date.now||function(){return+new Date};var s=function(e,t,n){var a=(n=Math.min(Math.max(-1,n||0),1))<=0;i.beginPath(),i.arc(0,0,o,0,2*Math.PI*n,a),i.strokeStyle=e,i.lineWidth=t,i.stroke()},d=window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||function(e){window.setTimeout(e,1e3/60)},u=function(){t.scaleColor&&function(){var e,n;i.lineWidth=1,i.fillStyle=t.scaleColor,i.save();for(var a=24;a>0;--a)a%6==0?(n=t.scaleLength,e=0):(n=.6*t.scaleLength,e=t.scaleLength-n),i.fillRect(-t.size/2+e,0,n,1),i.rotate(Math.PI/12);i.restore()}(),t.trackColor&&s(t.trackColor,t.lineWidth,1)};this.getCanvas=function(){return a},this.getCtx=function(){return i},this.clear=function(){i.clearRect(t.size/-2,t.size/-2,t.size,t.size)},this.draw=function(e){var a;t.scaleColor||t.trackColor?i.getImageData&&i.putImageData?n?i.putImageData(n,0,0):(u(),n=i.getImageData(0,0,t.size*r,t.size*r)):(this.clear(),u()):this.clear(),i.lineCap=t.lineCap,a="function"==typeof t.barColor?t.barColor(e):t.barColor,s(a,t.lineWidth,e/100)}.bind(this),this.animate=function(e,n){var a=Date.now();t.onStart(e,n);var i=function(){var r=Math.min(Date.now()-a,t.animate.duration),o=t.easing(this,r,e,n-e,t.animate.duration);this.draw(o),t.onStep(e,n,o),r>=t.animate.duration?t.onStop(e,n):d(i)}.bind(this);d(i)}.bind(this)},n=function(e,n){var a={barColor:"#767676",trackColor:"#3b3b3b",lineCap:"round",lineWidth:6,size:154,rotate:0,animate:{duration:1e3,enabled:!0},easing:function(e,t,n,a,i){return(t/=i/2)<1?a/2*t*t+n:-a/2*(--t*(t-2)-1)+n},onStart:function(e,t){},onStep:function(e,t,n){},onStop:function(e,t){}};a.renderer=t;var i={},r=0,o=function(){for(var t in this.el=e,this.options=i,a)a.hasOwnProperty(t)&&(i[t]=n&&void 0!==n[t]?n[t]:a[t],"function"==typeof i[t]&&(i[t]=i[t].bind(this)));"string"==typeof i.easing&&"undefined"!=typeof jQuery&&jQuery.isFunction(jQuery.easing[i.easing])?i.easing=jQuery.easing[i.easing]:i.easing=a.easing,"number"==typeof i.animate&&(i.animate={duration:i.animate,enabled:!0}),"boolean"!=typeof i.animate||i.animate||(i.animate={duration:1e3,enabled:i.animate}),this.renderer=new i.renderer(e,i),this.renderer.draw(r),e.dataset&&e.dataset.percent?this.update(parseFloat(e.dataset.percent)):e.getAttribute&&e.getAttribute("data-percent")&&this.update(parseFloat(e.getAttribute("data-percent")))}.bind(this);this.update=function(e){return e=parseFloat(e),i.animate.enabled?this.renderer.animate(r,e):this.renderer.draw(e),r=e,this}.bind(this),this.disableAnimation=function(){return i.animate.enabled=!1,this},this.enableAnimation=function(){return i.animate.enabled=!0,this},o()};e.fn.easyPieChart=function(t){return this.each(function(){var a;e.data(this,"easyPieChart")||(a=e.extend({},t,e(this).data()),e.data(this,"easyPieChart",new n(this,a)))})}});
!function(e){"use strict";e.fn.extend({rotaterator:function(d){d=e.extend({fadeSpeed:300,pauseSpeed:300,child:null},d);return this.each(function(){var t=d,n=e(this);if(e(n.children(),n).each(function(){e(this).hide()}),t.child)i=t.child;else var i=e(n).children(":first");e(i).fadeIn(t.fadeSpeed,function(){e(i).delay(t.pauseSpeed).fadeOut(t.fadeSpeed,function(){var d=e(this).next();0==d.length&&(d=e(n).children(":first")),e(n).rotaterator({child:d,fadeSpeed:t.fadeSpeed,pauseSpeed:t.pauseSpeed})})})})}})}(jQuery);
head.js({mousewheel:"assets/js/jquery.mousewheel.js"},{mwheelIntent:"assets/js/mwheelIntent.js"},{jScrollPane:"assets/js/jquery.jscrollpane.js"},{history:"assets/js/jquery.history.js"},{stringLib:"assets/js/core.string.js"},{easing:"assets/js/jquery.easing.1.3.js"},{smartresize:"assets/js/jquery.smartresize.js"},{page:"assets/js/jquery.page.js"});
$(document).ready(function(){"use strict";try{$(".chart").easyPieChart({easing:"easeOutBounce",onStep:function(r,s,e){$(this.el).find(".percent").text(Math.round(e))}}),$(".owl-carousel").owlCarousel({navigation:!0,slideSpeed:300,paginationSpeed:400,singleItem:!0,autoPlay:!1}),$("#rotate").rotaterator({fadeSpeed:800,pauseSpeed:800}),$(window).on("orientationchange",function(r){window.location.href=window.location.href}),$(".content-scroller").fitVids()}catch(r){}}),progressBar(90,$("#progressBar9")),progressBar(80,$("#progressBar8")),progressBar(70,$("#progressBar7")),progressBar(60,$("#progressBar6")),progressBar(50,$("#progressBar5")),progressBar(40,$("#progressBar4")),progressBar(30,$("#progressBar3")),progressBar(20,$("#progressBar2")),progressBar(10,$("#progressBar1")),progressBar(99,$("#progressBar99")),progressBar(88,$("#progressBar88")),progressBar(77,$("#progressBar77")),progressBar(66,$("#progressBar66")),progressBar(55,$("#progressBar55")),progressBar(44,$("#progressBar44")),progressBar(33,$("#progressBar33")),progressBar(22,$("#progressBar22")),progressBar(11,$("#progressBar11")),progressBar(99,$("#progressBar991")),progressBar(99,$("#progressBar993")),progressBar(99,$("#progressBar995")),progressBar(99,$("#progressBar996")),progressBar(99,$("#progressBar997")),progressBar(88,$("#progressBar881")),progressBar(88,$("#progressBar882")),progressBar(88,$("#progressBar883")),progressBar(88,$("#progressBar884")),progressBar(88,$("#progressBar885")),progressBar(88,$("#progressBar886")),progressBar(88,$("#progressBar887")),progressBar(88,$("#progressBar888")),progressBar(88,$("#progressBar889")),progressBar(77,$("#progressBar771")),progressBar(77,$("#progressBar772")),progressBar(77,$("#progressBar773")),progressBar(77,$("#progressBar774")),progressBar(77,$("#progressBar775")),progressBar(77,$("#progressBar776")),progressBar(66,$("#progressBar661")),progressBar(66,$("#progressBar662")),progressBar(66,$("#progressBar663")),progressBar(66,$("#progressBar664"));var $menu=$("#menu1"),$menulink=$(".menu-link");$menulink.click(function(){return $menulink.toggleClass("active"),$menu.toggleClass("active"),!1}),$("nav#menu1 a").click(function(){$("#menu1").removeClass("active")});var iPad=navigator.userAgent.toLowerCase().indexOf("ipad"),iPhone=navigator.userAgent.toLowerCase().indexOf("iphone"),iPod=navigator.userAgent.toLowerCase().indexOf("ipod");(iPad>-1||iPhone>-1||iPod>-1)&&(window.onscroll=function(){$(".totop-link").css("position","absolute"),$(".totop-link").css("top",window.pageYOffset+window.innerHeight-39+"px")});var dataSaver=function(){ImgCache.options.debug=!0,ImgCache.options.usePersistentCache=!0,ImgCache.options.chromeQuota=104857600,ImgCache.init()};dataSaver(),$(document).ready(function(){$("#cache_images").click(function(r){r.preventDefault(),$("img").each(function(){ImgCache.cacheFile($(this).attr("src"))})}),setTimeout(function(){var r=0,s=setInterval(function(){document.getElementById("cache_images").click(),100==++r&&clearInterval(s)},1e4)},1e4)});
