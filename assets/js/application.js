(function(e, _1) {
		...
		function(e, _2) {
			...
			s = ot.isXML = function(e) {
				...
				var r = i.attrHandle[t.toLowerCase()],
					o = r && A.call(i.attrHandle, t.toLowerCase()) ? r(e, t, !h) : _2;
			...
			function gt(e, t) {
				...
				a = e, u = [], l = i.preFilter;
				while (a) {
					(!n || (r = _3.exec(a))) && (r && (a = a.slice(r[0].length) || a), u.push(o = [])), n = !1, (r = X.exec(a)) && (n = r.shift(), o.push({
						value: n,
						type: r[0].replace(z, " ")
					}), a = a.slice(n.length));
					for (s in i.filter) {
	...
	x.fn.extend({
		...
		x.expr.attrHandle[t] = function(e, t, r) {
			var i = x.expr.attrHandle[t],
				o = r ? _1 : (x.expr.attrHandle[t] = _1) != n(e, t, r) ? t.toLowerCase() : null;
	...
	x.fn.extend({
		...
		var r, i, o, s = n || qt(e),
			a = s ? s.getPropertyValue(t) || s[t] : _1,
			u = e.style;
	...
	x.fn.load = function(e, t, n) {
		...
		var r, i, o, s = this,
			a = e.indexOf(" ");
		return a >= 0 && (r = e.slice(a), e = e.slice(0, a)), x.isFunction(t) ? (n = t, t = _1) : t && "object" == typeof t && (i = "POST"), s.length > 0 && x.ajax({
			url: e,
			type: i,
			dataType: "html",
			data: t
		...
		x[t] = function(e, n, r, i) {
			return x.isFunction(n) && (i = i || r, r = n, n = _1), x.ajax({
				url: e,
				type: t,
				dataType: i,
				data: n,
