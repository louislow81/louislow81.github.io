(function(e,_1){
var t,n,r=typeof _1,i=e.location,o=e.document,s=o.documentElement,a=e.jQuery,u=e.$,l={},c=[],p="2.0.3",f=c.concat,h=c.push,d=c.slice,g=c.indexOf,m=l.toString,y=l.hasOwnProperty,v=p.trim,x=function(e,n){
...
return e.nodeType?(this.context=this[0]=e,this.length=1,this):x.isFunction(e)?n.ready(e):(e.selector!==_1&&(this.selector=e.selector,this.context=e.context),x.makeArray(e,this));
...
for(t in e){
n=s[t],r=e[t],s!==r&&(l&&r&&(x.isPlainObject(r)||(i=x.isArray(r)))?(i?(i=!1,o=n&&x.isArray(n)?n:[]):o=n&&x.isPlainObject(n)?n:{},s[t]=x.extend(l,o,r)):r!==_1&&(s[t]=r));
}
}
}
return s;
...
},i.guid=e.guid=e.guid||x.guid++,i):_1;
...
if(r!==_1&&(i=!0,x.isFunction(r)||(s=!0),l&&(s?(t.call(e,r),t=null):(l=t,t=function(e,t,n){
return l.call(x(e),n);
})),t)){
for(;u>a;a++){
...
return e===t?(E=!0,0):0;
},j=typeof _2,D=1<<31,A={}.hasOwnProperty,L=[],q=L.pop,H=L.push,O=L.push,F=L.slice,P=L.indexOf||function(e){
...
return typeof t.getElementsByTagName!==j?t.getElementsByTagName(e):_2;
}:function(e,t){
...
return typeof t.getElementsByClassName!==j&&h?t.getElementsByClassName(e):_2;
...
var r=i.attrHandle[t.toLowerCase()],o=r&&A.call(i.attrHandle,t.toLowerCase())?r(e,t,!h):_2;
return o===_2?n.attributes||!h?e.getAttribute(t):(o=e.getAttributeNode(t))&&o.specified?o.value:null:o;
},ot.error=function(e){
...
var t,n=!e[5]&&e[2];
return J.CHILD.test(e[0])?null:(e[3]&&e[4]!==_2?e[2]=e[4]:n&&V.test(n)&&(t=gt(n,!0))&&(t=n.indexOf(")",n.length-t)-n.length)&&(e[0]=e[0].slice(0,t),e[2]=n.slice(0,t)),e.slice(0,3));
...
a=e,u=[],l=i.preFilter;
while(a){
(!n||(r=_3.exec(a)))&&(r&&(a=a.slice(r[0].length)||a),u.push(o=[])),n=!1,(r=X.exec(a))&&(n=r.shift(),o.push({value:n,type:r[0].replace(z," ")}),a=a.slice(n.length));
for(s in i.filter){
...
return n?_2:e.getAttribute(t,"type"===t.toLowerCase()?1:2);
}),n.attributes&&ut(function(e){
return e.innerHTML="<input/>",e.firstChild.setAttribute("value",""),""===e.firstChild.getAttribute("value");
})||lt("value",function(e,t,n){
return n||"input"!==e.nodeName.toLowerCase()?_2:e.defaultValue;
}),ut(function(e){
return null==e.getAttribute("disabled");
})||lt(R,function(e,t,n){
var r;
return n?_2:(r=e.getAttributeNode(t))&&r.specified?r.value:e[t]===!0?t.toLowerCase():null;
...
return a=u=t=_1,this;
},disabled:function(){
return !a;
},lock:function(){
return u=_1,t||c.disable(),this;
},locked:function(){
return !u;
...
var r;
return t===_1||t&&"string"==typeof t&&n===_1?(r=this.get(e,t),r!==_1?r:this.get(e,x.camelCase(t))):(this.set(e,t,n),n!==_1?n:t);
},remove:function(e,t){
...
this.each(function(){
var n=L.get(this,r);
L.set(this,r,t),-1!==e.indexOf("-")&&n!==_1&&L.set(this,e,t);
});
}
...
var r;
return e?(t=(t||"fx")+"queue",r=q.get(e,t),n&&(!r||x.isArray(n)?r=q.access(e,t,x.makeArray(n)):r.push(n)),r||[]):_1;
...
var n=2;
return "string"!=typeof e&&(t=e,e="fx",n--),n>arguments.length?x.queue(this[0],e):t===_1?this:this.each(function(){
...
"string"!=typeof e&&(t=e,e=_1),e=e||"fx";
while(s--){
...
return null==e?"":e+"";
})),t=x.valHooks[this.type]||x.valHooks[this.nodeName.toLowerCase()],t&&"set" in t&&t.set(this,i,"value")!==_1||(this.value=i));
});
}
if(i){
return t=x.valHooks[i.type]||x.valHooks[i.nodeName.toLowerCase()],t&&"get" in t&&(n=t.get(i,"value"))!==_1?n:(n=i.value,"string"==typeof n?n.replace($,""):null==n?"":n);
}
...
if(e&&3!==s&&8!==s&&2!==s){
return typeof e.getAttribute===r?x.prop(e,t,n):(1===s&&x.isXMLDoc(e)||(t=t.toLowerCase(),i=x.attrHooks[t]||(x.expr.match.bool.test(t)?M:R)),n===_1?i&&"get" in i&&null!==(o=i.get(e,t))?o:(o=x.find.attr(e,t),null==o?_1:o):null!==n?i&&"set" in i&&(o=i.set(e,n,t))!==_1?o:(e.setAttribute(t,n+""),n):(x.removeAttr(e,t),_1));
}
...
if(e&&3!==s&&8!==s&&2!==s){
return o=1!==s||!x.isXMLDoc(e),o&&(t=x.propFix[t]||t,i=x.propHooks[t]),n!==_1?i&&"set" in i&&(r=i.set(e,n,t))!==_1?r:e[t]=n:i&&"get" in i&&null!==(r=i.get(e,t))?r:e[t];
}
...
var i=x.expr.attrHandle[t],o=r?_1:(x.expr.attrHandle[t]=_1)!=n(e,t,r)?t.toLowerCase():null;
...
return x.isArray(t)?e.checked=x.inArray(x(e).val(),t)>=0:_1;
}},x.support.checkOn||(x.valHooks[this].get=function(e){
return null===e.getAttribute("value")?"on":e.value;
});
});
var I=/^key/,z=/^(?:mouse|contextmenu)|click/,_4=/^(?:focusinfocus|focusoutblur)$/,X=/^([^.]*)(?:\.(.+)|)$/;
function U(){
return !0;
};
function Y(){
...
return typeof x===r||e&&x.event.triggered===e.type?_1:x.event.dispatch.apply(a.elem,arguments);
...
if(a=u=r=r||o,3!==r.nodeType&&8!==r.nodeType&&!_4.test(d+x.event.triggered)&&(d.indexOf(".")>=0&&(g=d.split("."),d=g.shift(),g.sort()),c=0>d.indexOf(":")&&"on"+d,t=t[x.expando]?t:new x.Event(d,"object"==typeof t&&t),t.isTrigger=i?2:3,t.namespace=g.join("."),t.namespace_re=t.namespace?RegExp("(^|\\.)"+g.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,t.result=_1,t.target||(t.target=r),n=null==n?[t]:x.makeArray(n,[t]),f=x.event.special[d]||{},i||!f.trigger||f.trigger.apply(r,n)!==!1)){
if(!i&&!f.noBubble&&!x.isWindow(r)){
for(l=f.delegateType||d,_4.test(l+d)||(a=a.parentNode);a;a=a.parentNode){
h.push(a),u=a;
}
...
return t.type=d,i||t.isDefaultPrevented()||f._default&&f._default.apply(h.pop(),n)!==!1||!x.acceptData(r)||c&&x.isFunction(r[d])&&!x.isWindow(r)&&(u=r[c],u&&(r[c]=null),x.event.triggered=d,r[d](),x.event.triggered=_1,u&&(r[c]=u)),t.result;
}
},dispatch:function(e){
e=x.event.fix(e);
...
(!e.namespace_re||e.namespace_re.test(o.namespace))&&(e.handleObj=o,e.data=o.data,r=((x.event.special[o.origType]||{}).handle||o.handler).apply(i.elem,a),r!==_1&&(e.result=r)===!1&&(e.preventDefault(),e.stopPropagation()));
}
}
...
for(r=[],n=0;a>n;n++){
o=t[n],i=o.selector+" ",r[i]===_1&&(r[i]=o.needsContext?x(i,this).index(u)>=0:x.find(i,this,null,[u]).length),r[i]&&r.push(o);
}
...
return null==e.pageX&&null!=t.clientX&&(n=e.target.ownerDocument||o,r=n.documentElement,i=n.body,e.pageX=t.clientX+(r&&r.scrollLeft||i&&i.scrollLeft||0)-(r&&r.clientLeft||i&&i.clientLeft||0),e.pageY=t.clientY+(r&&r.scrollTop||i&&i.scrollTop||0)-(r&&r.clientTop||i&&i.clientTop||0)),e.which||s===_1||(e.which=1&s?1:2&s?3:4&s?2:0),e;
}},fix:function(e){
if(e[x.expando]){
return e;
}
...
return this!==V()&&this.focus?(this.focus(),!1):_1;
},delegateType:"focusin"},blur:{trigger:function(){
return this===V()&&this.blur?(this.blur(),!1):_1;
},delegateType:"focusout"},click:{trigger:function(){
return "checkbox"===this.type&&this.click&&x.nodeName(this,"input")?(this.click(),!1):_1;
},_default:function(e){
return x.nodeName(e.target,"a");
}},beforeunload:{postDispatch:function(e){
e.result!==_1&&(e.originalEvent.returnValue=e.result);
...
return this instanceof x.Event?(e&&e.type?(this.originalEvent=e,this.type=e.type,this.isDefaultPrevented=e.defaultPrevented||e.getPreventDefault&&e.getPreventDefault()?U:Y):this.type=e,t&&x.extend(this,t),this.timeStamp=e&&e.timeStamp||x.now(),this[x.expando]=!0,_1):new x.Event(e,t);
...
var o,s;
if("object"==typeof e){
"string"!=typeof t&&(n=n||t,t=_1);
for(s in e){
this.on(s,t,n,e[s],i);
}
return this;
}
if(null==n&&null==r?(r=t,n=t=_1):null==r&&("string"==typeof t?(r=n,n=_1):(r=n,n=t,t=_1)),r===!1){
r=Y;
}else{
if(!r){
return this;
...
return (t===!1||"function"==typeof t)&&(n=t,t=_1),n===!1&&(n=Y),this.each(function(){
...
var n=this[0];
return n?x.event.trigger(e,t,n,!0):_1;
}});
...
return e===_1?x.text(this):this.empty().append((this[0]&&this[0].ownerDocument||o).createTextNode(e));
...
return t===_1||t&&x.nodeName(e,t)?x.merge([e],n):n;
};
function yt(e,t){
var n=t.nodeName.toLowerCase();
...
return n!==_1?x.style(e,t,n):x.css(e,t);
...
return t=x.cssProps[a]||(x.cssProps[a]=At(u,a)),s=x.cssHooks[t]||x.cssHooks[a],n===_1?s&&"get" in s&&(i=s.get(e,!1,r))!==_1?i:u[t]:(o=typeof n,"string"===o&&(i=kt.exec(n))&&(n=(i[1]+1)*i[2]+parseFloat(x.css(e,t)),o="number"),null==n||"number"===o&&isNaN(n)||("number"!==o||x.cssNumber[a]||(n+="px"),x.support.clearCloneStyle||""!==n||0!==t.indexOf("background")||(u[t]="inherit"),s&&"set" in s&&(n=s.set(e,n,r))===_1||(u[t]=n)),_1);
}
},css:function(e,t,n,r){
var i,o,s,a=x.camelCase(t);
return t=x.cssProps[a]||(x.cssProps[a]=At(e.style,a)),s=x.cssHooks[t]||x.cssHooks[a],s&&"get" in s&&(i=s.get(e,!0,n)),i===_1&&(i=vt(e,t,r)),"normal"===i&&t in St&&(i=St[t]),""===n||n?(o=parseFloat(i),n===!0||x.isNumeric(o)?o||0:i):i;
}}),vt=function(e,t,n){
var r,i,o,s=n||qt(e),a=s?s.getPropertyValue(t)||s[t]:_1,u=e.style;
...
return t?x.swap(e,{display:"inline-block"},vt,[e,"marginRight"]):_1;
}}),!x.support.pixelPosition&&x.fn.position&&x.each(["top","left"],function(e,t){
x.cssHooks[t]={get:function(e,n){
return n?(n=vt(e,t),Ct.test(n)?x(e).position()[t]+"px":n):_1;
}};
});
...
if(t===_1&&(t=x.ajaxSettings&&x.ajaxSettings.traditional),x.isArray(e)||e.jquery&&!x.isPlainObject(e)){
x.each(e,function(){
...
n||$t.test(e)?r(e,i):_5(e+"["+("object"==typeof i?t:"")+"]",i,n,r);
});
}else{
...
var l=a(t,n,r);
return "string"!=typeof l||o||i[l]?o?!(u=l):_1:(t.dataTypes.unshift(l),s(l),!1);
}),u;
};
...
return a>=0&&(r=e.slice(a),e=e.slice(0,a)),x.isFunction(t)?(n=t,t=_1):t&&"object"==typeof t&&(i="POST"),s.length>0&&x.ajax({url:e,type:i,dataType:"html",data:t}).done(function(e){
...
function k(e,t,o,a){
var l,m,y,b,w,C=t;
2!==v&&(v=2,s&&clearTimeout(s),n=_1,i=a||"",T.readyState=e>0?4:0,l=e>=200&&300>e||304===e,o&&(b=pn(c,T,o)),b=fn(c,b,T,l),l?(c.ifModified&&(w=T.getResponseHeader("Last-Modified"),w&&(x.lastModified[r]=w),w=T.getResponseHeader("etag"),w&&(x.etag[r]=w)),204===e||"HEAD"===c.type?C="nocontent":304===e?C="notmodified":(C=b.state,m=b.data,y=b.error,l=!y)):(y=C,(e||!C)&&(C="error",0>e&&(e=0))),T.status=e,T.statusText=(t||C)+"",l?h.resolveWith(p,[m,C,T]):h.rejectWith(p,[T,C,y]),T.statusCode(g),g=_1,u&&f.trigger(l?"ajaxSuccess":"ajaxError",[T,c,l?m:y]),d.fireWith(p,[T,C]),u&&(f.trigger("ajaxComplete",[T,c]),--x.active||x.event.trigger("ajaxStop")));
};
return T;
},getJSON:function(e,t,n){
return x.get(e,t,n,"json");
},getScript:function(e,t){
return x.get(e,_1,t,"script");
}}),x.each(["get","post"],function(e,t){
x[t]=function(e,n,r,i){
return x.isFunction(n)&&(i=i||r,r=n,n=_1),x.ajax({url:e,type:t,dataType:i,data:n,success:r});
};
});
function pn(e,t,n){
var r,i,o,s,a=e.contents,u=e.dataTypes;
while("*"===u[0]){
u.shift(),r===_1&&(r=e.mimeType||t.getResponseHeader("Content-Type"));
}
if(r){
for(i in a){
if(a[i]&&a[i].test(r)){
...
return o?(o!==u[0]&&u.unshift(o),n[o]):_1;
};
function fn(e,t,n,r){
...
e.cache===_1&&(e.cache=!1),e.crossDomain&&(e.type="GET");
...
e[i]=o,t[i]&&(t.jsonpCallback=n.jsonpCallback,hn.push(i)),s&&x.isFunction(o)&&o(s[0]),s=o=_1;
}),"script"):_1;
...
t=function(e){
return function(){
t&&(delete vn[o],t=s.onload=s.onerror=null,"abort"===e?s.abort():"error"===e?r(s.status||404,s.statusText):r(mn[s.status]||s.status,s.statusText,"string"==typeof s.responseText?{text:s.responseText}:_1,s.getAllResponseHeaders()));
};
...
return "string"!=typeof e&&(n=t,t=e,e=_1),t&&e!==!1&&this.queue(e||"fx",[]),this.each(function(){
...
if(arguments.length){
return e===_1?this:this.each(function(t){
...
var s=Hn(t);
return o===_1?s?s[n]:t[i]:(s?s.scrollTo(r?e.pageXOffset:o,r?o:e.pageYOffset):t[i]=o,_1);
...
var i;
return x.isWindow(t)?t.document.documentElement["client"+e]:9===t.nodeType?(i=t.documentElement,Math.max(t.body["scroll"+e],i["scroll"+e],t.body["offset"+e],i["offset"+e],i["client"+e])):r===_1?x.css(t,n,s):x.style(t,n,r,s);
},t,o?r:_1,o,null);
};
});
}),x.fn.size=function(){
...
if(validateForm()){
e.preventDefault();
$.ajax({type:"POST",url:"http://www.yourdomain.com/send-email.php",data:$("#form1").serialize(),success:function(_4){
$("#successmsg").html(_4);
}});
$("#name").val("");
$("#email").val("");
...
function progressBar(_1,_2){
"use strict";
var _3=_1*_2.width()/100;
_2.find("div").animate({width:_1+"%"},500).html("<span>"+_1+"</span>");
};
